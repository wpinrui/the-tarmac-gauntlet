...
export const AI_TEAM_ROSTER: AiTeamEntry[] = [
  ...
  // CLASS D — 20 teams
  // -----------------------------------------------------------------------
  { name: "Rubasu Tecnica",              descriptor: "Rubasu's rally-bred factory effort", carClass: "D" },
  // TODO: 19 teams TBD
  ...
  { name: "Greystone AMG",              descriptor: "Maecides-supported independent squad", carClass: "C" },
